...
export function DriveThruScreen({ testMode = false }: { testMode?: boolean }) {
    ...
    return (
        <div className="h-screen w-full relative overflow-hidden bg-[#0a0a0a]">
            ...
            {/* HEADER - FIXED POSITIONING (TOP-0) */}
            <div className="fixed top-0 left-0 right-0 h-24 z-[9999] glass-panel rounded-b-2xl p-6 flex items-center justify-between bg-[#141414]/95 backdrop-blur-xl border-b border-white/10 shadow-2xl">
                <div className="flex items-center gap-6">
                    <img src="/logo.png" alt="Quick Logo" className="h-14 object-contain drop-shadow-lg" />
                    <div className="h-10 w-[1px] bg-white/20"></div>
                    <h1 className="text-3xl font-bold text-white tracking-wider">DRIVE-THRU</h1>
                </div>
                <div className="flex items-center gap-6">
                    {/* Debug Info */}
